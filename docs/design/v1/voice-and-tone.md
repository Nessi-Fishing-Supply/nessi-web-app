# Voice & Tone -- Nessi Design System v1

Source: Nessi Design System v2.0 (March 2026)

## Personality

Knowledgeable fishing friend -- not a platform. Earned, specific, tactile.

**Litmus test:** Would a 52-year-old muskie collector or a 26-year-old lure maker read this and think "these people get it"?
...
1. Never expose error codes or technical language to users
2. Never use generic marketplace hype language
3. Never use exclamation marks in promotional copy
4. Use species-specific and gear-specific language -- it proves credibility
5. Be honest about condition -- "one honest paragraph beats five stars"
6. Error messages must be specific, human, and offer a path forward
7. Empty states are marketing moments -- use them to guide, not to complain
