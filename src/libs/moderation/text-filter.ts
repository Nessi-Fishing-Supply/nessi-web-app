import type { ModerationContext, TextScanResult } from './types';
import { EXPLICIT_BLOCKLIST } from './config/blocklist';
...
export function scanText(content: string, context: ModerationContext): TextScanResult {
